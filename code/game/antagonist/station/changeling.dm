...
/datum/antagonist/changeling/callidus
	id = MODE_CALLIDUS
	role_text = "Callidus Assassin"
	role_text_plural = "Callidus Assassins"
	feedback_tag = "changeling_objective"
	blacklisted_jobs = list(/datum/job/ai, /datum/job/cyborg)
	protected_jobs = list(/datum/job/officer, /datum/job/warden, /datum/job/detective, /datum/job/captain, /datum/job/hos)
	welcome_text = ""
...
/datum/antagonist/changeling/create_objectives(var/datum/mind/changeling)
	...
	if(!(changeling.special_role == "Callidus Assassin"))
	//OBJECTIVES - Always absorb 5 genomes, plus random heretic objectives.
