...
/mob/living/carbon/human/proc/chapterselection()
	...
	switch(chapterchoice)
		if("Raven Guard")
			...
			equip_to_slot_or_del(new /obj/item/clothing/glasses/astarte/visor, slot_in_backpack)
		...
		if("Raven Guard Apothecary")
			...
			equip_to_slot_or_del(new /obj/item/storage/box/ifak, slot_l_store)
			equip_to_slot_or_del(new /obj/item/clothing/glasses/astarte/visor/apoc, slot_in_backpack)
