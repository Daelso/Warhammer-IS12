...
/mob/living/carbon/human/proc/retinueselection()
	...
	switch(chapterchoice)
		...
		if ("Tempestus Scion")
			equip_to_slot_or_del(new /obj/item/clothing/suit/armor/stormtrooper, slot_wear_suit)
			equip_to_slot_or_del(new /obj/item/clothing/head/helmet/stormtrooper, slot_head)
