...
/obj/item/clothing/accessory/armorplate/merc
	...
	armor = list(melee = 30, bullet = 30, laser = 30, energy = 10, bomb = 20, bio = 0, rad = 0)
	slowdown = 1
...
/obj/item/clothing/accessory/armguards/merc
	...
	armor = list(melee = 5, bullet = 12, laser = 5, energy = 5, bomb = 12, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armguards/ballistic
	...
	armor = list(melee = 5, bullet = 10, laser = 5, energy = 5, bomb = 10, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/armguards/ablative
	...
	armor = list(melee = 5, bullet = 5, laser = 15, energy = 10, bomb = 5, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/legguards/merc
	...
	armor = list(melee = 8, bullet = 8, laser = 8, energy = 8, bomb = 8, bio = 0, rad = 0)
...
/obj/item/clothing/accessory/legguards/ballistic
	...
	armor = list(melee = 5, bullet = 8, laser = 5, energy = 5, bomb = 5, bio = 0, rad = 0)
	siemens_coefficient = 0.7
	slowdown = 1
...
/obj/item/clothing/accessory/legguards/ablative
	...
	armor = list(melee = 5, bullet = 5, laser = 8, energy = 5, bomb = 5, bio = 0, rad = 0)
	siemens_coefficient = 0
	slowdown = 1
