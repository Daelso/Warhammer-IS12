...
/datum/reagent/space_cleaner
	name = "Trench cleaner"
	description = "A compound used to clean trenches. Now with 50% more sodium hypochlorite!"
...
/datum/reagent/lube // TODO: spraying on borgs speeds them up
	name = "Trench Lube"
	description = "Lubricant is a substance introduced between two moving surfaces to reduce the friction and wear between them. DO NOT ERP IN THE TRENCHES!"
